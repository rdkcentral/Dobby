...
For an architectural map before setting up the development VM, see the [subsystem documentation index](../docs/README.md), especially the [daemon](../daemon/README.md), [bundle](../bundle/README.md), and [AppInfrastructure](../AppInfrastructure/README.md) guides.
