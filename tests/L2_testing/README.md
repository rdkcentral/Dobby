...
The L2 scenarios exercise the runtime workflows described in the [daemon guide](../../daemon/README.md), [bundle guide](../../bundle/README.md), and [RDK plugin guide](../../rdkPlugins/README.md).
