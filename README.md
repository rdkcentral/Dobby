...
| :------------------------- | :---------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|     `-CMAKE_BUILD_TYPE`     | Debug/Release                                        |      Build the Debug or Release version.<br/><br/>If built in Release mode, `DobbyTool` and `DobbyBundleGenerator` will not be installed, and logging will be reduced. The only way to interact with Dobby is via dbus or the OCIContainer plugin in RDKServices.       |
