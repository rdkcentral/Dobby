...
For the shared hook contract and plugin loading flow, see the [RDK plugin guide](../../../docs/rdk-plugins.md) and [plugin launcher guide](../../../docs/plugin-launcher.md). This README remains the source for minidump configuration.
