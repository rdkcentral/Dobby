 ...
 *
 */
class RdkPluginBase : public IDobbyRdkPlugin
{
public:
    virtual ~RdkPluginBase() {}
...
public:
    // See OCI Documentation here for more info on OCI hooks: https://github.com/opencontainers/runtime-spec/blob/master/config.md#posix-platform-hooks
