...
#define AI_DEBUG_LEVEL_INFO             4 // Only in debug builds
#define AI_DEBUG_LEVEL_DEBUG            5 // Only in debug builds
...
/**
 * The verbosity flag determines what's actually printed, but some builds
 * can't print certain log messages
 *
 * In all builds we support up to milestone level logging
 **/
...
/**
 * In release builds disable info/debug logging
 **/
...
/**
 * Enable info/debug logging in debug builds
 **/
